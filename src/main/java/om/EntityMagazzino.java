...
/**
 * EntityMagazzino. Classe che rappresenta un record nel registro di magazzino. Le istanze di questa classe descrivono un determinato tipo di prodotto presente in magazzino e la relativa giacenza
